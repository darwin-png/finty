      ...
      <header className="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b border-gray-100 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            <Link href="/"><Image src="/logo.png" alt="Finty" width={120} height={38} className="h-9 w-auto" /></Link>
      ...
      <footer className="bg-white text-gray-500 py-12 px-4 sm:px-6 border-t border-gray-200">
        <div className="max-w-6xl mx-auto">
          <div className="grid sm:grid-cols-4 gap-8 mb-10">
            <div>
              <Image src="/logo.png" alt="Finty" width={100} height={32} className="h-8 w-auto" />
